...
module RequestParamsValidation
  ...
  #
  # Example:
  #   - config.definitions_path = 'config/resources'
  # That means the params definitions should be in: "#{Rails.root}/config/resources/**/*"
  #
  # The default path is :definitions.
  mattr_accessor :definitions_path
  self.definitions_path = :definitions


  # The configuration variable on_definition_not_found accepts two values: :nothing or :raise.
  ...
  #          executed without running the validations.
  ...
  # If it is an ActionController::Parameters, it sets the permitted attribute to true.
  #
  ...
  # maintain those keys, but if you feel the need to remove them, you can set this option
  # as follow.
  #
  # Example:
  ...
  # Extension configuration goes here. Here you can extend some behaviour and
  ...
  module ExtensionConfiguration
    ...
    # create a module which defined the method "valid_cellphone?(value)" and pass that module
  ...
  #
  # Notice that the local configuration on a resource definition will have more precedence
